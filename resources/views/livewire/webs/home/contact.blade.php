                    ...
                    <form action="" method="get">
                        <div class="form-row">
                            <div class="form-group col-md-6 p-3.5 ">
                                <label>
                                    <input type="text" class="form-control w-72" placeholder="Your Name" />
                                </label>
                            </div>
                            <div class="form-group col-md-6 p-3.5">
                                <label>
                                    <input type="email" class="form-control w-72" placeholder="Your Email" />
                                </label>
                            </div>
                        </div>
                        <div class="form-group p-3.5">
                            <label>
                                <input type="text" class="form-control w-72" placeholder="Subject" />
                            </label>
                        </div>
                        <div class="form-group p-3.5">
                            <label>
                                <textarea class="form-control w-72" rows="5" placeholder="Message"></textarea>
                            </label>
                        </div>
                        <div class="p-3 self-center flex-1 text-center">
                            <button id="button" type="submit" class="bg-indigo-600 shadow-xl hover:bg-indigo-500 text-white font-bold rounded-full p-4 w-60">Send message</button>
                        </div>
                    </form>
                </div>
            </div>
