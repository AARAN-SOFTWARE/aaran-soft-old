...
<div class="contact  relative mx-auto justify-items-center h-full p-10 bg-gradient-to-r from-violet-200 to-blue-300" id="contact">
    <div class="container justify-items-center mx-auto ">
        <div class="section-header  justify-items-center">
    ...
    <div class="row items-center w-full  p-5 grid grid-cols-2  ">
        <div class=" grid-cols-1 w-96 ml-80 h-auto  p-10 ">
            <div class="form">
                <form action="" method="get">
                    ...
                    <div class="p-3.5">
                        <button class="w-52" type="submit">Send Message</button>
                    </div>
                </form>
            </div>
        </div>
        <div class=" w-full h-full  p-5 justify-items-center mx-auto ">
...
<div class="w-full bg-gray-300">
    <div class="container w-full h-auto px-5 py-6 mx-auto flex items-center sm:flex-row flex-col bg-gray-300 ">
