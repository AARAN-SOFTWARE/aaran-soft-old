    ...
    <header id="header" class="header py-20 text-center md:pt-36  xl:flex ">
        <div class="container flex py-20">
            <div class="w-full p-5">
                ...
                <a class="btn-solid-lg hover:bg-emerald-400 rounded gap-3 bordered bg-gray-400 border-gray-500 p-3" href="#your-link"><i class="fab fa-apple border-gray-500 hover:underline hover:bg-blue-500 "></i>register</a>
            </div>
        ...
        <div class=" justify-items-center grid grid-cols-3 p-3 gap-3 w-full  mx-auto">
            ...
            <div class=" mb-3.5 grid-cols-1 w-72 h-80 shadow-2xl  gap-4 border rounded-2xl bg-blue-50">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-4  font-medium">You sales force can use the app on any smartphone platform without compatibility issues</p>
                </div>
            </div>
...
{{--           <---items--->--}}
            ...
            <div class="card relative block rounded bg-purple-100 w-80 h-auto grid-cols-4 gap-3 flex-col mr-auto mb-6 ml-auto mx-auto shadow-md ">
                <div class="card-body p-8">
                    ...
                    <div class="button-wrapper absolute pb-1.5 text-center ml-16">
                        <a class="border rounded-2xl p-2 flex gap-1.5 bg-rose-800  text-center" href="#Buy Now"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
            ...
            <div class="card relative block bg-purple-100 w-80 h-auto grid-cols-5 gap-3 mr-auto mx-auto mb-6 ml-auto border rounded shadow-md">
                <div class="card-body p-8">
                    ...
                    <div class="button-wrapper absolute pb-1.5 justify-items-center mx-auto ml-16 ">
                        <a class="border rounded-2xl p-2 bg-rose-800 gap-1.5 flex  text-center" href="#Buy Now"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                <path fill-rule="evenodd" d="M9.674 2.075a.75.75 0 0 1 .652 0l7.25 3.5A.75.75 0 0 1 17 6.957V16.5h.25a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1 0-1.5H3V6.957a.75.75 0 0 1-.576-1.382l7.25-3.5ZM11 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7.5 9.75a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Zm3.25 0a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Zm3.25 0a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Z" clip-rule="evenodd" />
                            </svg>Buy Now</a>
                    </div>
                </div>
            ...
            <div class="card relative block bg-purple-100 w-80 h-auto mr-auto grid-cols-6 gap-3 mb-6 ml-auto mx-auto border rounded shadow-md">
                <div class="card-body p-7">
                    ...
                    <div class="button-wrapper absolute pb-1.5 text-center ml-16">
                        <a class="border rounded-2xl p-2 gap-1.5 flex bg-rose-800" href="Buy Now"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                <path fill-rule="evenodd" d="M9.674 2.075a.75.75 0 0 1 .652 0l7.25 3.5A.75.75 0 0 1 17 6.957V16.5h.25a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1 0-1.5H3V6.957a.75.75 0 0 1-.576-1.382l7.25-3.5ZM11 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7.5 9.75a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Zm3.25 0a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Zm3.25 0a.75.75 0 0 0-1.5 0v5.5a.75.75 0 0 0 1.5 0v-5.5Z" clip-rule="evenodd" />
                            </svg>
                            Buy Now</a>
                    </div>
