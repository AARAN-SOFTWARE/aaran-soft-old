<nav class="px-2 sm:px-4 py-2.5  sticky inset-0 z-10 border-b-2 bg-purple-100 border-gray-200 xl:flex md:flex-row sm:flex-row-reverse">
...
{{--            <x-assets.logo.cxlogo--}}
        ...
        <div class="navbar-collapse offcanvas-collapse lx:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
            <ul class=" mr-90 mt-3 mb-2 ml-auto gap-12  flex-col list-none  lg:flex lg:flex-row">
                <li>
