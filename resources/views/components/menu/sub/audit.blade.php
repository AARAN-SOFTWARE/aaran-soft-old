...
<li class="flex align-center flex-col cursor-pointer">
    ...
    <div
            @click="selected !== 333 ? selected = 333 : selected = null"
...
{{--                            <x-aaranUi::icons.menu icon="terminal"/>--}}
                             <x-menu.header>Audit</x-menu.header>
                        </span>

        <span class="inline-flex justify-center items-center">
                        <svg fill="currentColor" viewBox="0 0 20 20"
                             :class="{'rotate-0': selected ==null, 'rotate-180': selected === 333}"
    ...
    <div x-show="selected === 333" class="p-1 flex flex-col">

        <ul class="grid-cols-1 grid bg-gray-800">

            @include('components.menu.items.audit-menu')
